    ...
    return (
        <div className={`${styles.wrap} displayBox`}>
            <div className={styles.outline}>
                ...
                <p className="cWhite">
                    <span className="serifBold cBlue">{siteConfig.submission.developedBy}&nbsp;</span>{" "}
                    <span className="">{submission.members || "No team members listed"}</span>
                </p>

                <p className="cWhite">
                    <span className="serifBold cBlue">{siteConfig.submission.builtUsing}&nbsp;&nbsp;</span>{" "}
                    <span className="">
                ...
                <p className="cWhite">
                    <span className="serifBold cBlue">{siteConfig.submission.chosenPrompt}</span>{" "}
                    <span className="">
                        {submission.prompt === null ? (
                            <span className="cRed">{siteConfig.submission.noPrompt}</span>
                        ) : (
                            submission.prompt
                        )}
                    </span>
                ...
                <span className="console sub">
                    <p className="cBlue serifBold">
                        {submission.sub_code === "Github" ? (
                            ...
                            <span className="cRed">{siteConfig.submission.codeNotSubmitted}</span>
                        ) : (
                        ...
                        {submission.sub_video === "NOT SUBMITTED" ? (
                            <span className="cRed">{siteConfig.submission.videoNotSubmitted}</span>
                        ) : (
