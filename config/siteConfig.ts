...
export const defaultSiteConfig: SiteConfig = {
    ...
    login: {
        heading: "User Login",
        description: "This is the portal for competitor, voter, and judge account login.",
        emailNote: "Please note you should login using your @basischina.com Microsoft email account.",
        accountTypeLabels: {
            0: "Visitor/Voter",
            1: "Competitor",
            2: "Judge"
    ...
    dashboardJudge: {
        ...
        editForm: {
            ...
            description: "You can add information such as technologies and title."
        }
    },
